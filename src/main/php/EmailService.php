...
class EmailServiceClient implements \EmailServiceIf {
  ...
  {
    $args = new \EmailService_getApiVersion_args();
  ...
  public function recv_getApiVersion()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\EmailService_getApiVersion_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \EmailService_getApiVersion_result();
  ...
  public function send_sendEmail(\SendEmailRequest $request)
  {
    $args = new \EmailService_sendEmail_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\EmailService_sendEmail_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \EmailService_sendEmail_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
