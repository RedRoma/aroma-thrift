...
class MessageServiceClient implements \RedRoma\Aroma\MessageService\MessageServiceIf {
  ...
  public function recv_getApiVersion()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\RedRoma\Aroma\MessageService\MessageService_getApiVersion_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \RedRoma\Aroma\MessageService\MessageService_getApiVersion_result();
