...
var IOSDevice = module.exports.IOSDevice = function(args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRING) {
        this.deviceToken = input.readBinary();
      } else {
        input.skip(ftype);
      }
      break;
...
var AndroidDevice = module.exports.AndroidDevice = function(args) {
...
var WindowsPhoneDevice = module.exports.WindowsPhoneDevice = function(args) {
};
...
var MobileDevice = module.exports.MobileDevice = function(args) {
  this.iosDevice = null;
...
var PushNotificationPayload = module.exports.PushNotificationPayload = function(args) {
  this.messageId = null;
...
var SlackChannel = module.exports.SlackChannel = function(args) {
...
var SlackUsername = module.exports.SlackUsername = function(args) {
  this.domainName = null;
  this.username = null;
  this.slackToken = null;
  if (args) {
...
var CustomChannel = module.exports.CustomChannel = function(args) {
  this.endpoint = null;
  if (args) {
...
var AromaChannel = module.exports.AromaChannel = function(args) {
...
var ReceiveMessageRequest = module.exports.ReceiveMessageRequest = function(args) {
  this.message = null;
  if (args) {
