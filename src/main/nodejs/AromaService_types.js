    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem38 = null;
            elem38 = new Channels_ttypes.AromaChannel();
            elem38.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem53 = null;
            elem53 = new Aroma_ttypes.Application();
            elem53.read(input);
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem60 = null;
            elem60 = new Events_ttypes.HealthCheckFailed();
            elem60.read(input);
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem67 = null;
            elem67 = new Events_ttypes.Event();
            elem67.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem102 = null;
            elem102 = new Aroma_ttypes.Application();
            elem102.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem118 = null;
            elem118 = new Channels_ttypes.AromaChannel();
            elem118.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem134 = null;
            elem134 = new Aroma_ttypes.ServiceAnnouncement();
            elem134.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem142 = null;
            elem142 = new Aroma_ttypes.Application();
            elem142.read(input);
