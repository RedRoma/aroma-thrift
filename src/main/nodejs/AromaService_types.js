    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem54 = null;
            elem54 = new Channels_ttypes.AromaChannel();
            elem54.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem69 = null;
            elem69 = new Aroma_ttypes.Application();
            elem69.read(input);
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem76 = null;
            elem76 = new Events_ttypes.HealthCheckFailed();
            elem76.read(input);
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem83 = null;
            elem83 = new Events_ttypes.Event();
            elem83.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem110 = null;
            elem110 = new Aroma_ttypes.Message();
            elem110.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem134 = null;
            elem134 = new Channels_ttypes.AromaChannel();
            elem134.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem142 = null;
            elem142 = new Events_ttypes.Event();
            elem142.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem150 = null;
            elem150 = new Reactions_ttypes.Reaction();
            elem150.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem166 = null;
            elem166 = new Aroma_ttypes.Application();
            elem166.read(input);
