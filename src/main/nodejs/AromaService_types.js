    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem110 = null;
            elem110 = new Channels_ttypes.AromaChannel();
            elem110.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem118 = null;
            elem118 = new Events_ttypes.Event();
            elem118.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem126 = null;
            elem126 = new Aroma_ttypes.ServiceAnnouncement();
            elem126.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem134 = null;
            elem134 = new Aroma_ttypes.Application();
            elem134.read(input);
