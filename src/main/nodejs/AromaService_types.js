  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem38 = null;
          elem38 = new Aroma_ttypes.Application();
          elem38.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem62 = null;
          elem62 = new Reactions_ttypes.Reaction();
          elem62.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem70 = null;
          elem70 = new Reactions_ttypes.Reaction();
          elem70.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem85 = null;
          elem85 = new Aroma_ttypes.Application();
          elem85.read(input);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem92 = null;
          elem92 = new Events_ttypes.HealthCheckFailed();
          elem92.read(input);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem99 = null;
          elem99 = new Events_ttypes.Event();
          elem99.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem118 = null;
          elem118 = new Aroma_ttypes.Message();
          elem118.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem126 = null;
          elem126 = new Aroma_ttypes.Message();
          elem126.read(input);
