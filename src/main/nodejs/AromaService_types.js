  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem38 = null;
          elem38 = new Reactions_ttypes.Reaction();
          elem38.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem46 = null;
          elem46 = new Reactions_ttypes.Reaction();
          elem46.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem61 = null;
          elem61 = new Aroma_ttypes.Application();
          elem61.read(input);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem68 = null;
          elem68 = new Events_ttypes.HealthCheckFailed();
          elem68.read(input);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem75 = null;
          elem75 = new Events_ttypes.Event();
          elem75.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem94 = null;
          elem94 = new Aroma_ttypes.Message();
          elem94.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem102 = null;
          elem102 = new Aroma_ttypes.Message();
          elem102.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem110 = null;
          elem110 = new Aroma_ttypes.Application();
          elem110.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem118 = null;
          elem118 = new Aroma_ttypes.Application();
          elem118.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem126 = null;
          elem126 = new Events_ttypes.Event();
          elem126.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem134 = null;
          elem134 = new Reactions_ttypes.Reaction();
          elem134.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem142 = null;
          elem142 = new Aroma_ttypes.ServiceAnnouncement();
          elem142.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem150 = null;
          elem150 = new Aroma_ttypes.Application();
          elem150.read(input);
