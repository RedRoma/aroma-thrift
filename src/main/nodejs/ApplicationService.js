...
var ApplicationService_getApiVersion_args = function(args) {
};
...
var ApplicationService_getApiVersion_result = function(args) {
  this.success = null;
  if (args) {
...
var ApplicationService_sendMessage_args = function(args) {
  this.request = null;
  if (args) {
...
var ApplicationService_sendMessage_result = function(args) {
  this.success = null;
  this.ex1 = null;
  this.ex2 = null;
  this.ex3 = null;
...
var ApplicationService_sendMessageAsync_args = function(args) {
  this.request = null;
  if (args) {
    if (args.request !== undefined && args.request !== null) {
      this.request = new ttypes.SendMessageRequest(args.request);
...
var ApplicationService_sendMessageAsync_result = function(args) {
};
...
ApplicationServiceClient.prototype.send_getApiVersion = function() {
...
ApplicationServiceClient.prototype.recv_getApiVersion = function(input,mtype,rseqid) {
...
ApplicationServiceClient.prototype.send_sendMessage = function(request) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('sendMessage', Thrift.MessageType.CALL, this.seqid());
  var params = {
    request: request
  };
  var args = new ApplicationService_sendMessage_args(params);
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
};

ApplicationServiceClient.prototype.recv_sendMessage = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
...
ApplicationServiceClient.prototype.send_sendMessageAsync = function(request) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('sendMessageAsync', Thrift.MessageType.ONEWAY, this.seqid());
  var params = {
    request: request
  };
  var args = new ApplicationService_sendMessageAsync_args(params);
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
};
...
;
ApplicationServiceProcessor.prototype.process_getApiVersion = function(seqid, input, output) {
  var args = new ApplicationService_getApiVersion_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getApiVersion.length === 0) {
    Q.fcall(this._handler.getApiVersion.bind(this._handler))
      .then(function(result) {
        var result_obj = new ApplicationService_getApiVersion_result({success: result});
    ...
    this._handler.getApiVersion(function (err, result) {
      ...
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new ApplicationService_getApiVersion_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("getApiVersion", Thrift.MessageType.REPLY, seqid);
      } else {
...
ApplicationServiceProcessor.prototype.process_sendMessage = function(seqid, input, output) {
  var args = new ApplicationService_sendMessage_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.sendMessage.length === 1) {
    Q.fcall(this._handler.sendMessage.bind(this._handler), args.request)
      .then(function(result) {
        var result_obj = new ApplicationService_sendMessage_result({success: result});
        ...
        if (err instanceof Exceptions_ttypes.OperationFailedException || err instanceof Exceptions_ttypes.InvalidArgumentException || err instanceof Exceptions_ttypes.InvalidTokenException) {
          result = new ApplicationService_sendMessage_result(err);
          output.writeMessageBegin("sendMessage", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.sendMessage(args.request, function (err, result) {
      ...
      if ((err === null || typeof err === 'undefined') || err instanceof Exceptions_ttypes.OperationFailedException || err instanceof Exceptions_ttypes.InvalidArgumentException || err instanceof Exceptions_ttypes.InvalidTokenException) {
        result_obj = new ApplicationService_sendMessage_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("sendMessage", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("sendMessage", Thrift.MessageType.EXCEPTION, seqid);
...
ApplicationServiceProcessor.prototype.process_sendMessageAsync = function(seqid, input, output) {
