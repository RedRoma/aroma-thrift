...
var NotificationService_getApiVersion_args = function(args) {
};
...
var NotificationService_getApiVersion_result = function(args) {
  this.success = null;
  if (args) {
...
var NotificationService_sendNotification_args = function(args) {
  this.request = null;
  if (args) {
...
var NotificationService_sendNotification_result = function(args) {
  this.success = null;
  this.ex1 = null;
  this.ex2 = null;
  this.ex3 = null;
  ...
  if (this._handler.getApiVersion.length === 0) {
    Q.fcall(this._handler.getApiVersion.bind(this._handler))
      .then(function(result) {
        var result_obj = new NotificationService_getApiVersion_result({success: result});
    ...
    this._handler.getApiVersion(function (err, result) {
      ...
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new NotificationService_getApiVersion_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("getApiVersion", Thrift.MessageType.REPLY, seqid);
      } else {
...
NotificationServiceProcessor.prototype.process_sendNotification = function(seqid, input, output) {
  ...
  if (this._handler.sendNotification.length === 1) {
    Q.fcall(this._handler.sendNotification.bind(this._handler), args.request)
      .then(function(result) {
        var result_obj = new NotificationService_sendNotification_result({success: result});
        ...
        if (err instanceof Exceptions_ttypes.InvalidArgumentException || err instanceof Exceptions_ttypes.OperationFailedException || err instanceof Exceptions_ttypes.InvalidTokenException) {
          result = new NotificationService_sendNotification_result(err);
          output.writeMessageBegin("sendNotification", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.sendNotification(args.request, function (err, result) {
      ...
      if ((err === null || typeof err === 'undefined') || err instanceof Exceptions_ttypes.InvalidArgumentException || err instanceof Exceptions_ttypes.OperationFailedException || err instanceof Exceptions_ttypes.InvalidTokenException) {
        result_obj = new NotificationService_sendNotification_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("sendNotification", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("sendNotification", Thrift.MessageType.EXCEPTION, seqid);
