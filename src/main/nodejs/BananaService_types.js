    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem21 = null;
            elem21 = new Banana_ttypes.Application();
            elem21.read(input);
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem28 = null;
            elem28 = new Events_ttypes.HealthCheckFailed();
            elem28.read(input);
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem35 = null;
            elem35 = new Events_ttypes.GeneralEvent();
            elem35.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem46 = null;
            elem46 = new Banana_ttypes.Message();
            elem46.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem54 = null;
            elem54 = new Banana_ttypes.Application();
            elem54.read(input);
