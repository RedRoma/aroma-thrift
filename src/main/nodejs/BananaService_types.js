    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem22 = null;
            elem22 = new Channels_ttypes.BananaChannel();
            elem22.read(input);
...
GetBuzzResponse = module.exports.GetBuzzResponse = function(args) {
    ...
    if (args) {
        ...
        if (args.happenings !== undefined && args.happenings !== null) {
            this.happenings = Thrift.copyList(args.happenings, [Events_ttypes.GeneralEvent]);
        }
    }
};
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem44 = null;
            elem44 = new Events_ttypes.HealthCheckFailed();
            elem44.read(input);
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem51 = null;
            elem51 = new Events_ttypes.GeneralEvent();
            elem51.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem62 = null;
            elem62 = new Banana_ttypes.Message();
            elem62.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem86 = null;
            elem86 = new Channels_ttypes.BananaChannel();
            elem86.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem94 = null;
            elem94 = new Events_ttypes.Event();
            elem94.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem102 = null;
            elem102 = new Banana_ttypes.ServiceAnnouncement();
            elem102.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem110 = null;
            elem110 = new Banana_ttypes.Application();
            elem110.read(input);
