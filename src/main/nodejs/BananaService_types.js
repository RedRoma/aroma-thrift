    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem94 = null;
            elem94 = new Channels_ttypes.BananaChannel();
            elem94.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem102 = null;
            elem102 = new Events_ttypes.Event();
            elem102.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem110 = null;
            elem110 = new Banana_ttypes.ServiceAnnouncement();
            elem110.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem118 = null;
            elem118 = new Banana_ttypes.Application();
            elem118.read(input);
