...
ProvisionApplicationRequest = module.exports.ProvisionApplicationRequest = function(args) {
  ...
  if (args) {
    if (args.token !== undefined && args.token !== null) {
      this.token = new Authentication_ttypes.HumanToken(args.token);
    }
...
ProvisionApplicationRequest.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.token = new Authentication_ttypes.HumanToken();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem46 = null;
          elem46 = new Banana_ttypes.Application();
          elem46.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem54 = null;
          elem54 = new Banana_ttypes.Human();
          elem54.read(input);
