    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem54 = null;
            elem54 = new Banana_ttypes.Message();
            elem54.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem70 = null;
            elem70 = new Banana_ttypes.Application();
            elem70.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem78 = null;
            elem78 = new Channels_ttypes.BananaChannel();
            elem78.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem86 = null;
            elem86 = new Events_ttypes.Event();
            elem86.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem94 = null;
            elem94 = new Banana_ttypes.ServiceAnnouncement();
            elem94.read(input);
    ...
    while (true)
    {
      ...
      switch (fid)
      {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          {
            var elem102 = null;
            elem102 = new Banana_ttypes.Application();
            elem102.read(input);
