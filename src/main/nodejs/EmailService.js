...
EmailServiceClient = exports.Client = function(output, pClass) {
        this.output = output;
        this.pClass = pClass;
        this._seqid = 0;
        this._reqs = {};
...
EmailServiceProcessor = exports.Processor = function(handler)     {
      ...
      if (this._handler.getApiVersion.length === 0) {
        Q.fcall(this._handler.getApiVersion)
          .then(function(result) {
            var result = new EmailService_getApiVersion_result({success: result});
        ...
        this._handler.getApiVersion(function (err, result) {
          if (err == null) {
            var result = new EmailService_getApiVersion_result((err != null ? err : {success: result}));
            output.writeMessageBegin("getApiVersion", Thrift.MessageType.REPLY, seqid);
          } else {
            var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
            output.writeMessageBegin("getApiVersion", Thrift.MessageType.EXCEPTION, seqid);
    ...
    EmailServiceProcessor.prototype.process_sendEmail = function(seqid, input, output)     {
      ...
      if (this._handler.sendEmail.length === 1) {
        Q.fcall(this._handler.sendEmail, args.request)
          .then(function(result) {
            var result = new EmailService_sendEmail_result({success: result});
            ...
            if (err instanceof Exceptions_ttypes.InvalidArgumentException || err instanceof Exceptions_ttypes.OperationFailedException || err instanceof Exceptions_ttypes.InvalidTokenException) {
              var result = new EmailService_sendEmail_result(err);
              output.writeMessageBegin("sendEmail", Thrift.MessageType.REPLY, seqid);
            } else {
              var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        ...
        this._handler.sendEmail(args.request, function (err, result) {
          if (err == null || err instanceof Exceptions_ttypes.InvalidArgumentException || err instanceof Exceptions_ttypes.OperationFailedException || err instanceof Exceptions_ttypes.InvalidTokenException) {
            var result = new EmailService_sendEmail_result((err != null ? err : {success: result}));
            output.writeMessageBegin("sendEmail", Thrift.MessageType.REPLY, seqid);
          } else {
            var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
            output.writeMessageBegin("sendEmail", Thrift.MessageType.EXCEPTION, seqid);
