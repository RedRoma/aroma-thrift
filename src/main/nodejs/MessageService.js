...
var MessageService_getApiVersion_args = function(args) {
};
...
var MessageService_getApiVersion_result = function(args) {
  this.success = null;
  if (args) {
  ...
  if (this._handler.getApiVersion.length === 0) {
    Q.fcall(this._handler.getApiVersion.bind(this._handler))
      .then(function(result) {
        var result_obj = new MessageService_getApiVersion_result({success: result});
    ...
    this._handler.getApiVersion(function (err, result) {
      ...
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new MessageService_getApiVersion_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("getApiVersion", Thrift.MessageType.REPLY, seqid);
      } else {
