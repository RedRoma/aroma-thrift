...
var LengthOfTime = module.exports.LengthOfTime = function(args) {
  this.unit = null;
  this.value = null;
  if (args) {
...
var Dimension = module.exports.Dimension = function(args) {
  this.width = null;
  this.height = null;
  if (args) {
...
var Image = module.exports.Image = function(args) {
  this.imageType = null;
  this.data = null;
  this.dimension = null;
  if (args) {
...
var Organization = module.exports.Organization = function(args) {
  ...
  if (args) {
    ...
    if (args.logo !== undefined && args.logo !== null) {
      this.logo = new ttypes.Image(args.logo);
    }
...
Organization.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.techStack = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 7:
      if (ftype == Thrift.Type.STRING) {
        this.organizationEmail = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      case 8:
      if (ftype == Thrift.Type.STRING) {
        this.stockMarketSymbol = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 12:
      if (ftype == Thrift.Type.STRING) {
        this.organizationDescription = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
User.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 12:
      if (ftype == Thrift.Type.I64) {
        this.timeUserJoined = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
...
Application.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 12:
      if (ftype == Thrift.Type.I64) {
        this.timeOfTokenExpiration = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      case 13:
      if (ftype == Thrift.Type.STRING) {
        this.applicationIconMediaId = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
var ServiceAnnouncement = module.exports.ServiceAnnouncement = function(args) {
  this.message = null;
