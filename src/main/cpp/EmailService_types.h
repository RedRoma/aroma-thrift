...
class SendEmailRequest : public virtual ::apache::thrift::TBase {
 public:
...
std::ostream& operator<<(std::ostream& out, const SendEmailRequest& obj);


class SendEmailResponse : public virtual ::apache::thrift::TBase {
 public:
...
std::ostream& operator<<(std::ostream& out, const SendEmailResponse& obj);
