...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > ApplicationEndpointProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ApplicationEndpointIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< ApplicationEndpointIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new ApplicationEndpointProcessor(handler));
  return processor;
}
