...
void Endpoint::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "Endpoint(";
  out << "tcp="; (__isset.tcp ? (out << to_string(tcp)) : (out << "<null>"));
  out << ", " << "httpThrift="; (__isset.httpThrift ? (out << to_string(httpThrift)) : (out << "<null>"));
  out << ", " << "httpRest="; (__isset.httpRest ? (out << to_string(httpRest)) : (out << "<null>"));
  out << ")";
}
