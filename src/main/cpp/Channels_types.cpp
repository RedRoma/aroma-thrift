...
void MobileDevice::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "MobileDevice(";
  out << "iosDevice="; (__isset.iosDevice ? (out << to_string(iosDevice)) : (out << "<null>"));
  out << ", " << "androidDevice="; (__isset.androidDevice ? (out << to_string(androidDevice)) : (out << "<null>"));
  out << ", " << "windowsPhoneDevice="; (__isset.windowsPhoneDevice ? (out << to_string(windowsPhoneDevice)) : (out << "<null>"));
  out << ")";
}
...
void AromaChannel::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "AromaChannel(";
  out << "slackChannel="; (__isset.slackChannel ? (out << to_string(slackChannel)) : (out << "<null>"));
  out << ", " << "slackUsername="; (__isset.slackUsername ? (out << to_string(slackUsername)) : (out << "<null>"));
  out << ", " << "email="; (__isset.email ? (out << to_string(email)) : (out << "<null>"));
  out << ", " << "customChannel="; (__isset.customChannel ? (out << to_string(customChannel)) : (out << "<null>"));
  out << ", " << "iosDevice="; (__isset.iosDevice ? (out << to_string(iosDevice)) : (out << "<null>"));
  out << ", " << "androidDevice="; (__isset.androidDevice ? (out << to_string(androidDevice)) : (out << "<null>"));
  out << ", " << "windowsPhoneDevice="; (__isset.windowsPhoneDevice ? (out << to_string(windowsPhoneDevice)) : (out << "<null>"));
  out << ")";
