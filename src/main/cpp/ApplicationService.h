...
class ApplicationServiceIfSingletonFactory : virtual public ApplicationServiceIfFactory {
 public:
  ApplicationServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<ApplicationServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<ApplicationServiceIf> iface_;
};
...
class ApplicationServiceClient : virtual public ApplicationServiceIf {
 public:
  ApplicationServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  ApplicationServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class ApplicationServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  ApplicationServiceProcessor(::apache::thrift::stdcxx::shared_ptr<ApplicationServiceIf> iface) :
    iface_(iface) {
...
class ApplicationServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  ApplicationServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< ApplicationServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< ApplicationServiceIfFactory > handlerFactory_;
};

class ApplicationServiceMultiface : virtual public ApplicationServiceIf {
 public:
  ApplicationServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<ApplicationServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~ApplicationServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<ApplicationServiceIf> > ifaces_;
  ApplicationServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<ApplicationServiceIf> iface) {
...
class ApplicationServiceConcurrentClient : virtual public ApplicationServiceIf {
 public:
  ApplicationServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  ApplicationServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
