...
std::ostream& operator<<(std::ostream& out, const ImageType::type& val) {
  std::map<int, const char*>::const_iterator it = _ImageType_VALUES_TO_NAMES.find(val);
  if (it != _ImageType_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
...
std::ostream& operator<<(std::ostream& out, const Industry::type& val) {
  std::map<int, const char*>::const_iterator it = _Industry_VALUES_TO_NAMES.find(val);
  if (it != _Industry_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::ostream& operator<<(std::ostream& out, const Tier::type& val) {
  std::map<int, const char*>::const_iterator it = _Tier_VALUES_TO_NAMES.find(val);
  if (it != _Tier_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::ostream& operator<<(std::ostream& out, const TimeUnit::type& val) {
  std::map<int, const char*>::const_iterator it = _TimeUnit_VALUES_TO_NAMES.find(val);
  if (it != _TimeUnit_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::ostream& operator<<(std::ostream& out, const ProgrammingLanguage::type& val) {
  std::map<int, const char*>::const_iterator it = _ProgrammingLanguage_VALUES_TO_NAMES.find(val);
  if (it != _ProgrammingLanguage_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::ostream& operator<<(std::ostream& out, const Urgency::type& val) {
  std::map<int, const char*>::const_iterator it = _Urgency_VALUES_TO_NAMES.find(val);
  if (it != _Urgency_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::ostream& operator<<(std::ostream& out, const LengthOfTime& obj)
{
  obj.printTo(out);
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const Organization& obj)
{
  obj.printTo(out);
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const Application& obj)
{
  obj.printTo(out);
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const ServiceAnnouncement& obj)
{
  obj.printTo(out);
  return out;
}
