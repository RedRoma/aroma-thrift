...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<AromaServiceHandler> handler(new AromaServiceHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new AromaServiceProcessor(handler));
