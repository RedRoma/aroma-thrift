...
class BananaMessageServiceHandler : virtual public BananaMessageServiceIf {
 public:
  BananaMessageServiceHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  shared_ptr<BananaMessageServiceHandler> handler(new BananaMessageServiceHandler());
  shared_ptr<TProcessor> processor(new BananaMessageServiceProcessor(handler));
