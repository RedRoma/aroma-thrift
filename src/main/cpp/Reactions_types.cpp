...
void AromaMatcher::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "AromaMatcher(";
  out << "all="; (__isset.all ? (out << to_string(all)) : (out << "<null>"));
  out << ", " << "titleIs="; (__isset.titleIs ? (out << to_string(titleIs)) : (out << "<null>"));
  out << ", " << "titleIsNot="; (__isset.titleIsNot ? (out << to_string(titleIsNot)) : (out << "<null>"));
  out << ", " << "titleContains="; (__isset.titleContains ? (out << to_string(titleContains)) : (out << "<null>"));
  out << ", " << "titleDoesNotContain="; (__isset.titleDoesNotContain ? (out << to_string(titleDoesNotContain)) : (out << "<null>"));
  out << ", " << "bodyIs="; (__isset.bodyIs ? (out << to_string(bodyIs)) : (out << "<null>"));
  out << ", " << "bodyContains="; (__isset.bodyContains ? (out << to_string(bodyContains)) : (out << "<null>"));
  out << ", " << "bodyDoesNotContain="; (__isset.bodyDoesNotContain ? (out << to_string(bodyDoesNotContain)) : (out << "<null>"));
  out << ", " << "urgencyEquals="; (__isset.urgencyEquals ? (out << to_string(urgencyEquals)) : (out << "<null>"));
  out << ", " << "hostnameIs="; (__isset.hostnameIs ? (out << to_string(hostnameIs)) : (out << "<null>"));
  out << ", " << "hostnameContains="; (__isset.hostnameContains ? (out << to_string(hostnameContains)) : (out << "<null>"));
  out << ", " << "hostnameDoesNotContain="; (__isset.hostnameDoesNotContain ? (out << to_string(hostnameDoesNotContain)) : (out << "<null>"));
  out << ", " << "applicationIs="; (__isset.applicationIs ? (out << to_string(applicationIs)) : (out << "<null>"));
  out << ", " << "applicationIsNot="; (__isset.applicationIsNot ? (out << to_string(applicationIsNot)) : (out << "<null>"));
  out << ")";
}
...
__isset.dontSendPushNotification = true;
}
...
uint32_t AromaAction::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.forwardToSlackChannel) {
  ...
  if (this->__isset.dontSendPushNotification) {
...
void AromaAction::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "AromaAction(";
  out << "forwardToSlackChannel="; (__isset.forwardToSlackChannel ? (out << to_string(forwardToSlackChannel)) : (out << "<null>"));
  out << ", " << "forwardToSlackUser="; (__isset.forwardToSlackUser ? (out << to_string(forwardToSlackUser)) : (out << "<null>"));
  out << ", " << "forwardToGitter="; (__isset.forwardToGitter ? (out << to_string(forwardToGitter)) : (out << "<null>"));
  out << ", " << "sendEmail="; (__isset.sendEmail ? (out << to_string(sendEmail)) : (out << "<null>"));
  out << ", " << "skipInbox="; (__isset.skipInbox ? (out << to_string(skipInbox)) : (out << "<null>"));
  out << ", " << "dontStoreMessage="; (__isset.dontStoreMessage ? (out << to_string(dontStoreMessage)) : (out << "<null>"));
  out << ", " << "responseWithMessage="; (__isset.responseWithMessage ? (out << to_string(responseWithMessage)) : (out << "<null>"));
  out << ", " << "forwardToUsers="; (__isset.forwardToUsers ? (out << to_string(forwardToUsers)) : (out << "<null>"));
  out << ", " << "sendPushNotification="; (__isset.sendPushNotification ? (out << to_string(sendPushNotification)) : (out << "<null>"));
  out << ", " << "dontSendPushNotification="; (__isset.dontSendPushNotification ? (out << to_string(dontSendPushNotification)) : (out << "<null>"));
  out << ")";
}
