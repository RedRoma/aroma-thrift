...
class LengthOfTime : public virtual ::apache::thrift::TBase {
 public:
...
class Dimension : public virtual ::apache::thrift::TBase {
 public:
...
class Organization : public virtual ::apache::thrift::TBase {
 public:
...
class Application : public virtual ::apache::thrift::TBase {
 public:
...
class ServiceAnnouncement : public virtual ::apache::thrift::TBase {
 public:
