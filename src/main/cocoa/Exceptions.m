...
@implementation BananaException_ThroughputExceeedException

- (id) init
{
  return [super initWithName: @"BananaException_ThroughputExceeedException" reason: @"unknown" userInfo: nil];
}
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if (![anObject isKindOfClass:[BananaException_ThroughputExceeedException class]]) {
    return NO;
  }
  BananaException_ThroughputExceeedException *other = (BananaException_ThroughputExceeedException *)anObject;
  if ((__message_isset != other->__message_isset) ||
      (__message_isset && ((__message || other->__message) && ![__message isEqual:other->__message]))) {
    return NO;
  }
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThroughputExceeedException"];
  if (__message_isset) {
    if (__message != nil) {
      [outProtocol writeFieldBeginWithName: @"message" type: TType_STRING fieldID: 1];
      [outProtocol writeString: __message];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"BananaException_ThroughputExceeedException("];
  [ms appendString: @"message:"];
  [ms appendFormat: @"\"%@\"", __message];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
