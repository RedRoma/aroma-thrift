    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_LIST) {
          ...
          {
            Banana_Service *_elem17 = [[Banana_Service alloc] init];
  ...
  if (__services_isset) {
    if (__services != nil) {
      [outProtocol writeFieldBeginWithName: @"services" type: TType_LIST fieldID: 1];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__services count]];
        int idx19;
        for (idx19 = 0; idx19 < [__services count]; idx19++)
        {
          [[__services objectAtIndex: idx19] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (id) init
{
  self = [super init];
#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
  self.developers = [[[NSMutableArray alloc] initWithCapacity:0] autorelease_stub];
...
{
  self = [super init];
  __developers = [developers retain_stub];
  __developers_isset = YES;
  return self;
}
...
{
  self = [super init];
  if ([decoder containsValueForKey: @"developers"])
  {
    __developers = [[decoder decodeObjectForKey: @"developers"] retain_stub];
    __developers_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  if (__developers_isset)
  {
    [encoder encodeObject: __developers forKey: @"developers"];
  }
}
...
{
  NSUInteger hash = 17;
  hash = (hash * 31) ^ __developers_isset ? 2654435761 : 0;
  if (__developers_isset)
  {
    hash = (hash * 31) ^ [__developers hash];
  }
  return hash;
}
...
- (BOOL) isEqual: (id) anObject
{
  ...
  if ((__developers_isset != other->__developers_isset) ||
      (__developers_isset && ((__developers || other->__developers) && ![__developers isEqual:other->__developers]))) {
    return NO;
  }
  return YES;
}
...
- (void) dealloc
{
  [__developers release_stub];
  [super dealloc_stub];
}

- (NSMutableArray *) developers {
  return [[__developers retain_stub] autorelease_stub];
}

- (void) setDevelopers: (NSMutableArray *) developers {
  [developers retain_stub];
  [__developers release_stub];
  __developers = developers;
  __developers_isset = YES;
}

- (BOOL) developersIsSet {
  return __developers_isset;
}

- (void) unsetDevelopers {
  [__developers release_stub];
  __developers = nil;
  __developers_isset = NO;
}
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_LIST) {
          ...
          {
            Banana_Developer *_elem22 = [[Banana_Developer alloc] init];
            [_elem22 read: inProtocol];
            [fieldValue addObject: _elem22];
            [_elem22 release_stub];
          }
          [inProtocol readListEnd];
          [self setDevelopers: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__developers_isset) {
    if (__developers != nil) {
      [outProtocol writeFieldBeginWithName: @"developers" type: TType_LIST fieldID: 1];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__developers count]];
        int idx24;
        for (idx24 = 0; idx24 < [__developers count]; idx24++)
        {
          [[__developers objectAtIndex: idx24] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  ...
  [ms appendString: @"developers:"];
  [ms appendFormat: @"%@", __developers];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_LIST) {
          ...
          {
            BananaChannels_BananaChannel *_elem27 = [[BananaChannels_BananaChannel alloc] init];
  ...
  if (__channels_isset) {
    if (__channels != nil) {
      [outProtocol writeFieldBeginWithName: @"channels" type: TType_LIST fieldID: 1];
      {
        ...
        int idx29;
        for (idx29 = 0; idx29 < [__channels count]; idx29++)
        {
          [[__channels objectAtIndex: idx29] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (id) init;
- (id) initWithSuccess: (BananaService_GetMySavedChannelsResponse *) success ex1: (BananaService_OperationFailedException) ex1 ex2: (BananaService_InvalidArgumentException) ex2 ex3: (BananaService_InvalidCredentialsException) ex3 ex4: (BananaService_UnauthorizedException) ex4;
