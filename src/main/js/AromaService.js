...
AromaService_recreateToken_args = function(args) {
  ...
  if (args) {
    if (args.request !== undefined && args.request !== null) {
      this.request = new RecreateApplicationTokenRequest(args.request);
    }
  }
};
...
AromaService_recreateToken_args.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.request = new RecreateApplicationTokenRequest();
        this.request.read(input);
      } else {
        input.skip(ftype);
      }
...
AromaService_recreateToken_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new RecreateApplicationTokenResponse(args.success);
    }
    if (args.ex1 !== undefined && args.ex1 !== null) {
      this.ex1 = args.ex1;
    }
...
AromaService_recreateToken_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new RecreateApplicationTokenResponse();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
AromaService_registerDevice_args = function(args) {
  ...
  if (args) {
    if (args.request !== undefined && args.request !== null) {
      this.request = new RegisterDeviceRequest(args.request);
    }
  }
};
...
AromaService_registerDevice_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new RegisterDeviceResponse(args.success);
    }
    if (args.ex1 !== undefined && args.ex1 !== null) {
      this.ex1 = args.ex1;
    }
...
AromaService_registerDevice_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new RegisterDeviceResponse();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
AromaService_unregisterDevice_args = function(args) {
  ...
  if (args) {
    if (args.request !== undefined && args.request !== null) {
      this.request = new UnregisterDeviceRequest(args.request);
    }
  }
};
...
AromaService_unregisterDevice_args.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.request = new UnregisterDeviceRequest();
        this.request.read(input);
      } else {
        input.skip(ftype);
      }
...
AromaService_unregisterDevice_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new UnregisterDeviceResponse(args.success);
    }
    if (args.ex1 !== undefined && args.ex1 !== null) {
      this.ex1 = args.ex1;
    }
...
AromaService_unregisterDevice_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new UnregisterDeviceResponse();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
AromaServiceClient.prototype.recreateToken = function(request, callback) {
  this.send_recreateToken(request, callback); 
  if (!callback) {
    return this.recv_recreateToken();
  }
};

AromaServiceClient.prototype.send_recreateToken = function(request, callback) {
  this.output.writeMessageBegin('recreateToken', Thrift.MessageType.CALL, this.seqid);
  var params = {
    request: request
  };
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_recreateToken();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AromaServiceClient.prototype.recv_recreateToken = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'recreateToken failed: unknown result';
};
...
AromaServiceClient.prototype.registerDevice = function(request, callback) {
  this.send_registerDevice(request, callback); 
  if (!callback) {
    return this.recv_registerDevice();
  }
};

AromaServiceClient.prototype.send_registerDevice = function(request, callback) {
...
AromaServiceClient.prototype.recv_registerDevice = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
...
AromaServiceClient.prototype.unregisterDevice = function(request, callback) {
  this.send_unregisterDevice(request, callback); 
  if (!callback) {
    return this.recv_unregisterDevice();
  }
};

AromaServiceClient.prototype.send_unregisterDevice = function(request, callback) {
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_unregisterDevice();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AromaServiceClient.prototype.recv_unregisterDevice = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'unregisterDevice failed: unknown result';
};
